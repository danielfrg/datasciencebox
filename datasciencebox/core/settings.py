...
class Settings(dict):
    ...
    def required_fields(self):
        ...
        if self['CLOUD'] == 'bare':
            ...
            return ['NUMBER_NODES', 'AWS_KEY', 'AWS_SECRET', 'AWS_KEYNAME', 'AWS_REGION', 'AWS_SECURITY_GROUPS', 'AWS_IMAGE', 'AWS_SIZE', 'USERNAME', 'KEYPAIR']
        elif self['CLOUD'] == 'gcp':
            return ['NUMBER_NODES', 'GCP_EMAIL', 'GCP_KEY_FILE', 'GCP_PROJECT', 'GCP_DATACENTER', 'GCP_IMAGE', 'GCP_SIZE', 'GCP_PUBLIC_KEY', 'GCP_NETWORK', 'USERNAME', 'KEYPAIR']
        else:
